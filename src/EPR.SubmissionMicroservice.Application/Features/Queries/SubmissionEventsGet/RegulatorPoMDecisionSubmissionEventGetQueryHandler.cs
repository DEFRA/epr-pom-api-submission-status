...
public class RegulatorPoMDecisionSubmissionEventGetQueryHandler : IRequestHandler<RegulatorPoMDecisionSubmissionEventGetQuery, ErrorOr<List<AbstractSubmissionEventGetResponse>>>
{
    ...
    public RegulatorPoMDecisionSubmissionEventGetQueryHandler(
    ...
    RegulatorPoMDecisionSubmissionEventGetQuery request,
