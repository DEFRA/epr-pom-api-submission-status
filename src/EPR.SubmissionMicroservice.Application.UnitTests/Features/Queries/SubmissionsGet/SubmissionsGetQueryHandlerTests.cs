...
public class SubmissionsGetQueryHandlerTests
{
    ...
    [TestMethod]
    public async Task Handle_ReturnsExpectedSubmissionList_WhenNoSubmissionsExistWithComplianceSchemeIdAndIsFirstComplianceSchemeQueryParamIsTrue()
    {
        // Arrange
        var submissions = new List<Submission>
        {
        ...
        _submissionQueryRepositoryMock.Verify(x => x.GetAll(e => e.OrganisationId == query.OrganisationId), Times.Exactly(2));
    }

    [TestMethod]
    public async Task Handle_ReturnsExpectedSubmissionList_WhenNoSubmissionsExistWithComplianceSchemeIdAndIsFirstComplianceSchemeQueryParamIsFalse()
    {
        // Arrange
        var query = new SubmissionsGetQuery
        {
