...
[TestClass]
public class RegulatorPoMDecisionSubmissionEventGetQueryHandlerTests
{
    ...
    private RegulatorPoMDecisionSubmissionEventGetQueryHandler _systemUnderTest;
    ...
    public void TestInitialize()
    {
        ...
        _systemUnderTest = new RegulatorPoMDecisionSubmissionEventGetQueryHandler(
    ...
    public async Task Handle_IdFilteredReturnsTwoGetResponses()
    {
        ...
        var query = new RegulatorPoMDecisionSubmissionEventGetQuery
        {
