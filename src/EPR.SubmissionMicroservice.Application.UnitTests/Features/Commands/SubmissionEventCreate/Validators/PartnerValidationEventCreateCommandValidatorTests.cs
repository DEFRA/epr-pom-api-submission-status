...
[TestClass]
public class PartnerValidationEventCreateCommandValidatorTests
{
    private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
    private readonly PartnerValidationEventCreateCommandValidator _systemUnderTest;

    public PartnerValidationEventCreateCommandValidatorTests()
    {
        _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
        _systemUnderTest = new PartnerValidationEventCreateCommandValidator(_mockQueryRepository.Object);
    }
