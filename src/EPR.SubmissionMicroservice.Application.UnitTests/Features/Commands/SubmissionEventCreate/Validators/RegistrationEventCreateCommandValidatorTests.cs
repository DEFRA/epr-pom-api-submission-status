...
[TestClass]
public class RegistrationEventCreateCommandValidatorTests
{
    private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
    private readonly RegistrationValidationEventCreateCommandValidator _systemUnderTest;

    public RegistrationEventCreateCommandValidatorTests()
    {
        _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
        _systemUnderTest = new RegistrationValidationEventCreateCommandValidator(_mockQueryRepository.Object);
    }
