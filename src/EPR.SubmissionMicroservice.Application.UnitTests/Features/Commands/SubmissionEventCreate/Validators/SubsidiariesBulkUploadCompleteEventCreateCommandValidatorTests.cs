...
[TestClass]
public class SubsidiariesBulkUploadCompleteEventCreateCommandValidatorTests
{
    private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
    private readonly SubsidiariesBulkUploadCompleteEventCreateCommandValidator _systemUnderTest;

    public SubsidiariesBulkUploadCompleteEventCreateCommandValidatorTests()
    {
        _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
        _systemUnderTest = new SubsidiariesBulkUploadCompleteEventCreateCommandValidator(_mockQueryRepository.Object);
    }
    ...
    {
        // Arrange
        var command = TestCommands.SubmissionEvent.ValidSubsidiariesBulkUploadCompleteEventCreateCommand();
