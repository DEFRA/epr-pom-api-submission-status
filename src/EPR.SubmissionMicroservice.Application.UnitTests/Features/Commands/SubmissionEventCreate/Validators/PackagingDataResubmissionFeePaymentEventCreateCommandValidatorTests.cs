...
{
    [TestClass]
    public class PackagingDataResubmissionFeePaymentEventCreateCommandValidatorTests
    {
        private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
        private readonly PackagingDataResubmissionFeePaymentEventCreateCommandValidator _systemUnderTest;

        public PackagingDataResubmissionFeePaymentEventCreateCommandValidatorTests()
        {
            _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
            _systemUnderTest = new PackagingDataResubmissionFeePaymentEventCreateCommandValidator(_mockQueryRepository.Object);
        }
        ...
        public async Task Validator_ReturnSuccess_WhenCommandValid()
        {
            ...
            var command = TestCommands.SubmissionEvent.ValidPackagingDataResubmissionFeePaymentEventCreateCommand();
