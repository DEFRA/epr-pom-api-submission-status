...
[TestClass]
public class FileDownloadCheckEventCreateCommandValidatorTests
{
    private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
    private readonly FileDownloadCheckEventCreateCommandValidator _systemUnderTest;

    public FileDownloadCheckEventCreateCommandValidatorTests()
    {
        _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
        _systemUnderTest = new FileDownloadCheckEventCreateCommandValidator(_mockQueryRepository.Object);
    }
    ...
    {
        // Arrange
        var command = TestCommands.SubmissionEvent.ValidCheckFileDownloadCheckEventCreateCommand();
