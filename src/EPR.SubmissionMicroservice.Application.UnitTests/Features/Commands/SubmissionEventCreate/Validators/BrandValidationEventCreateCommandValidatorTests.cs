...
[TestClass]
public class BrandValidationEventCreateCommandValidatorTests
{
    private readonly Mock<IQueryRepository<Submission>> _mockQueryRepository;
    private readonly BrandValidationEventCreateCommandValidator _systemUnderTest;

    public BrandValidationEventCreateCommandValidatorTests()
    {
        _mockQueryRepository = new Mock<IQueryRepository<Submission>>();
        _systemUnderTest = new BrandValidationEventCreateCommandValidator(_mockQueryRepository.Object);
    }
